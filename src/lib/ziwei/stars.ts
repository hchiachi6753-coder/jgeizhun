...
const BRIGHTNESS_TABLE: Record<string, Record<number, string>> = {
  // 主星（參考科技紫微網）
  '紫微': { 2: '廟', 3: '廟', 5: '旺', 6: '旺', 7: '廟', 8: '廟', 9: '廟', 11: '旺', 0: '旺' },
  '天機': { 2: '廟', 3: '廟', 6: '廟', 9: '廟', 0: '廟' },
  '太陽': { 2: '旺', 3: '廟', 4: '旺', 5: '旺', 6: '旺' },
  '武曲': { 4: '廟', 7: '旺', 10: '廟' },
  '天同': { 5: '廟', 11: '廟' },
  '廉貞': { 2: '廟', 5: '廟', 11: '陷' },
  '天府': { 2: '廟', 5: '廟', 6: '廟', 8: '旺', 9: '旺', 10: '廟' },
  '太陰': { 9: '廟', 10: '旺', 11: '廟', 0: '廟' },
  '貪狼': { 2: '廟', 6: '廟', 11: '陷' },
  '巨門': { 0: '旺', 1: '廟', 2: '廟' },
  '天相': { 1: '廟', 2: '廟', 3: '廟', 6: '廟', 7: '廟' },
  '天梁': { 0: '廟', 2: '廟', 6: '廟' },
  '七殺': { 2: '廟', 3: '旺', 6: '廟', 8: '廟', 10: '廟' },
  '破軍': { 0: '廟', 2: '廟', 4: '廟', 7: '旺', 8: '廟' },
  // 輔星
  '祿存': { 2: '廟', 3: '廟', 5: '廟', 6: '廟' },
  '文曲': { 9: '旺', 10: '廟', 11: '旺' },
  '文昌': { 3: '利', 4: '利' },
